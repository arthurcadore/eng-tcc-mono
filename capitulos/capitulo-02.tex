...
Onde \gls{gt} é o pulso utilizado na modulação de pulso de cada canal. Essa escolha se deve ao fato de que a convolução do sinal recebido com o pulso inverso no tempo do pulso de transmissão resulta em uma maximização da \gls{SNR} no instante de decisão, conforme demonstrado na teoria de detecção de sinais em presença de ruído \cite{10555531840}. A \gls{SNR} do sinal pode ser expressa como
