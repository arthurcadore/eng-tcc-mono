...
Quanto maior o \gls{alpha}, mais suave é a transição entre os símbolos, mas também maior é a largura de banda ocupada. A \autoref{fig:formatter_comp} apresenta a comparação entre os sinais \gls{dI} e \gls{dQ} quando é aplicada a modulação de pulso com pulso \gls{RRC} e \gls{Rect}, ou seja, quando o vetor de simbolos é apenas superamostrado \cite{10555531840}.
...
\noindent onde \gls{alpha} é o fator de roll-off do pulso e \gls{Tb} é o período de bit. Já para modulação de pulso \gls{Rect}, a banda do sinal modulado é dada por
